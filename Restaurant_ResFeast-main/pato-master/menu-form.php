      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 p-b-30">
            <div class="t-center">
              <span class="tit2 t-center"> Resfeast </span>

              <h3 class="tit3 t-center m-b-35 m-t-2">Add Menu</h3>
            </div>
            ...
            <form class="wrap-form-booking">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <!-- Email -->
                  <span class="txt9"> Number of Item </span>
