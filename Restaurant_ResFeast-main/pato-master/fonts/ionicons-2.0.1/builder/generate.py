...
def generate_cheatsheet(data):
  ...
  cheatsheet_file_path = os.path.join(ROOT_PATH, 'cheatsheet.php')
  template_path = os.path.join(BUILDER_PATH, 'cheatsheet', 'template.php')
  icon_row_path = os.path.join(BUILDER_PATH, 'cheatsheet', 'icon-row.php')
