...
if (isset($_GET['token'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            echo "<script>alert('Your password has been updated successfully. You can now login.'); window.location = 'login.php';</script>";
        }
    } else {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 p-b-30">
                    ...
                    <form class="wrap-form-booking" method="POST" action="reset-password.php<?php echo isset($_GET['token']) ? '?token=' . htmlspecialchars($_GET['token']) : ''; ?>">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- New Password -->
                                <label for="new_password" class="txt9">New Password</label>
                                <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <input id="new_password" class="bo-rad-10 sizefull txt10 p-l-20" type="password" name="new_password" placeholder="Enter your new password" required>
                                </div>
                            </div>
                        </div>
