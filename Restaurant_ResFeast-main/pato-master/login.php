        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 p-b-30">
                    ...
                    <form class="wrap-form-booking" method="POST" action="login.php">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Name -->
                            ...
                            <div class="col-md-6">
                                <!-- Password -->
                                <label for="password" class="txt9">Password</label>
                                <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <input id="password" class="bo-rad-10 sizefull txt10 p-l-20" type="password" name="password" placeholder="Password" required>
                                </div>
                            </div>
                        </div>
